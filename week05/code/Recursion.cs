...
public static class Recursion
{
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        string newPattern = pattern.Remove(index, 1);

        // Recursive calls for '0' and '1' replacements
        WildcardBinary(newPattern.Insert(index, "0"), results);
        WildcardBinary(newPattern.Insert(index, "1"), results);
    }
    /// <summary>
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        // Base Case: If we reach the end of the maze, print the path
        if (maze.IsEnd(x, y))
        {
