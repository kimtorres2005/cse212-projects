...
public class LinkedList : IEnumerable<int>
{
    ...
    public void RemoveTail()
    {
        ...
        {
            _tail.Prev!.Next = null; // Disconnect the second to last node from the tail node
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                if (curr == _head)
                {
                    RemoveHead(); // If the head contains the value, remove the head
                }
                else if (curr == _tail)
                {
                    RemoveTail(); // If the tail contains the value, remove the tail
                }
                else
                {
                ...
                return; // Stop searching after the first match is found and removed
            }
